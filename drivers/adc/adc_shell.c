...
static struct adc_hdl {
	...
	DT_FOREACH_STATUS_OKAY(adi_hudson_adc, ADC_HDL_LIST_ENTRY)
...
SHELL_SUBCMD_DICT_SET_CREATE(sub_gain_cmds, cmd_adc_gain,
	...
	(GAIN_6, ADC_GAIN_6, "x 6"),
	(GAIN_4, ADC_GAIN_4, "x 4"),
	(GAIN_8, ADC_GAIN_8, "x 8"),
	(GAIN_10, ADC_GAIN_10, "x 10"),
	(GAIN_12, ADC_GAIN_12, "x 12"),
	(GAIN_14, ADC_GAIN_14, "x 14"),
